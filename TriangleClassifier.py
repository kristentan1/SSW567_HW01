...
if __name__ == '__main__':
    ...
    print(classify_triangle(1.79, 1.79, 1.79))
    print(classify_triangle(1,2,1))
    print(classify_triangle(7,7,9))
    print(classify_triangle(100, 200, 200))
    print(classify_triangle(1.167, 1.167, 2.908))
    print(classify_triangle(100.995, 75.454, 100.995))
    print(classify_triangle(75.49, 82.32, 82.32))
    print(classify_triangle(3,7,8))
    print(classify_triangle(12, 15, 18))
    print(classify_triangle(4.567, 7.898, 9.555))
    print(classify_triangle(9.755, 3, 10.1572))
    print(classify_triangle(5, 3, 4))
    print(classify_triangle(3, 4, 5))
    print(classify_triangle(7, 24, 25))
    print(classify_triangle(24, 25, 7))
    print(classify_triangle(2.25, 4.55, 5.08))
    print(classify_triangle(1, 1, 2**0.5))
    print(classify_triangle(2.25, 3.75, 4.3732))
    print(classify_triangle(75.22, 34.89, 82.9178))
    print(classify_triangle_with_bugs(1, 1, 2))